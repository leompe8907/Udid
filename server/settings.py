...
# Fuerza HTTPS y cookies seguras
SECURE_SSL_REDIRECT = True
SESSION_COOKIE_SECURE = True
CSRF_COOKIE_SECURE = True

# HTTP Strict Transport Security (solo activar si TODO el tráfico es HTTPS)
SECURE_HSTS_SECONDS = 31536000  # 1 año
SECURE_HSTS_INCLUDE_SUBDOMAINS = True
SECURE_HSTS_PRELOAD = True

# Protección extra contra ataques comunes
SECURE_BROWSER_XSS_FILTER = True
SECURE_CONTENT_TYPE_NOSNIFF = True
X_FRAME_OPTIONS = 'DENY'

# Content Security Policy (opcional pero recomendable)
# Ajustá según tus dominios o APIs
SECURE_CROSS_ORIGIN_OPENER_POLICY = "same-origin"

# Configuración de proxy inverso (si usás Nginx/Traefik)
